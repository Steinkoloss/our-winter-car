namespace WinterMP.Net.Messages
{
    ...
    public enum MessageId : ushort
    {
        ...
        WiringState = 193,
        BatteryState = 194,
        EngineBlockState = 195,
        GearboxState = 196,
        VehicleCoolantState = 197,
        StarterDrawRequest = 198,
        StarterWearRequest = 199,
        HeaterState = 200,
        VehicleConditionReleaseAck = 201,
        VehicleDrivetrainWearState = 202,
        GearboxOilUseRequest = 203,
        GearboxWearRequest = 204,
        VehicleWheelHealthState = 205,
        ValveAdjustmentState = 206,
        CylinderHeadState = 207,
        MilkConditionState = 208,
        FirewoodBuyerState = 209,
        MooseMeatState = 210,
        UtilityPaymentIntent = 211,
        UtilityPaymentResult = 212,
        SessionSettings = 213,
        MooseCorpseState = 214,
        MooseChopIntent = 215,
        FirewoodLoadState = 216,
        FirewoodUnloadIntent = 217,
        WheelPunctureRequest = 218,
        StoveKnobIntent = 219,
        AtfBottleState = 220,
        AtfFillerState = 221,
        AtfRefillIntent = 222,
        FleaSaleResult = 223,
        FleaListingState = 224,
        FleaListingIntent = 225,
        FleaListingResult = 226,
        SupplyItemState = 227,
        WiringInstallRequest = 228,
        WiringInstallReceipt = 229,
        TaxiServiceState = 230,
        TaxiCallIntent = 231,
        TaxiMeterState = 232,
        TaxiMeterIntent = 233,
        TaxiFareState = 234,
        TaxiFareIntent = 235,
        TaxiPaydayReadIntent = 236,
        HouseholdFuseState = 237,
        HouseholdFuseIntent = 238,
        HouseholdFuseResult = 239,
        TractorTrailerState = 240,
        TractorTrailerIntent = 241,
        TractorTrailerMotion = 242,
        SausageOpenIntent = 243,
        SausageState = 244,
        CoffeeIntent = 245,
        CoffeeState = 246,
        CoffeeDrinkResult = 247,
        TrainState = 248,
        BulbState = 249,
        AdvertJobState = 250,
        AdvertSheetState = 251,
        AdvertIntent = 252,
        MotorOilBottleState = 253,
        MotorOilFillerState = 254,
