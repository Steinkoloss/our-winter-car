...
**Current objective:** a broad experimental alpha where every normal shared gameplay
loop has a plausible implementation, bugs expected. [SYNC-SCOPE-AUDIT.md](SYNC-SCOPE-AUDIT.md)
is the current inventory and work order and supersedes completion claims below.
...
| Save and resume | After host save/quit/reload and guest rejoin, the purchased items, remaining bag contents, money and player profiles resume correctly; the guest's personal world is untouched. | **19 local two-game checks pass** across native save and restart/rejoin stages (v214): shared cash, saved loose groceries, a partly full bag, remaining-only opening, both returning spawn choices and unchanged guest world files. Loading/save teardown no longer overwrites the guest profile; saved loose products reconstruct on peers. Separate disposable profiles and a probe-only stable UDP identity were used. [Evidence and limits](https://github.com/Steinkoloss/our-winter-car/blob/snapshot/hermes-2026-09-14/docs/BUILDING.md#save-and-resume-2026-09-13-unreleased-v214). The combined v220 local journey is recorded below; real Steam/two-PC and physical input remain open. |

Steam/two-PC acceptance is open for every row.
...
- **Native evidence** [Fresh table, price-entry, checkout and save findings](https://github.com/Steinkoloss/our-winter-car/blob/snapshot/hermes-2026-09-14/docs/SYNC-SCOPE-AUDIT.md#flea-market-native-audit-and-payment-dependency-2026-09-13-v236-unreleased). Native rental day 0 is active; collection appears after expiry. Unsold retrieval still needs inspection.
...
are covered. [Evidence](https://github.com/Steinkoloss/our-winter-car/blob/snapshot/hermes-2026-09-14/docs/BUILDING.md#guest-moose-chopping-2026-09-13-unreleased-v228).
