...
[live recovery audit](../docs/BUILDING.md#native-passenger-recovery-2026-09-13-unreleased-v226).
...
[Validation and remaining limits](../docs/BUILDING.md#guest-flywheelflexplate-inputs-protocol-147-unreleased)
...
[Native validation and limits](../docs/BUILDING.md#guest-rev-limiter-inputs-protocol-148-unreleased)
...
[Native validation and limits](../docs/BUILDING.md#guest-ignition-coil-replicas-and-input-protocol-149-unreleased)
...
[Native validation and limitations](../docs/BUILDING.md#guest-engine-wiring-inputs-protocol-150-unreleased)
...
factories remain 38/31. [Validation and limits](../docs/BUILDING.md#guest-starter-flywheel-input-protocol-151-unreleased)
...
38/31. [Validation and limits](../docs/BUILDING.md#guest-engine-block-inputs-protocol-153-unreleased)
...
remain separate work. [Validation and limits](../docs/BUILDING.md#guest-valve-adjustment-inputs-protocol-159-unreleased)
...
[validation and limits](../docs/BUILDING.md#vehicle-temperature-sources-and-gauges-still-protocol-165-unreleased).
...
See [validation and limits](../docs/BUILDING.md#host-oil-contamination-input-protocol-167-unreleased).
...
[Native validation and limits](../docs/BUILDING.md#host-engine-heating-inputs-protocol-168-unreleased).
...
[Native validation and limits](../docs/BUILDING.md#host-cooling-movement-speed-protocol-169-unreleased).
...
[Native validation and limits](../docs/BUILDING.md#host-cooling-rpm-inputs-protocol-170-unreleased).
...
[Native validation and limits](../docs/BUILDING.md#host-coolant-dashboard-protocol-171-unreleased).
...
previous check. [Validation and limits](../docs/BUILDING.md#guest-cabin-and-heater-temperature-protocol-173-unreleased).
...
[Validation and limits](../docs/BUILDING.md#guest-electrical-temperature-protocol-174-unreleased).
...
open. [Validation and limits](../docs/BUILDING.md#guest-accessory-battery-inputs-protocol-177-unreleased).
...
this wear writer. [Validation and limits](../docs/BUILDING.md#guest-starter-wear-protocol-179-unreleased).
...
or fit a heater on the guest. [Validation and limits](../docs/BUILDING.md#guest-heater-condition-protocol-180-unreleased).
...
is added. [Validation and limits](../docs/BUILDING.md#guest-heater-hose-inputs-protocol-182-unreleased).
...
and heat additions. [Validation and limits](../docs/BUILDING.md#guest-rear-window-heating-element-protocol-183-unreleased).
...
simulation. [Validation and limits](../docs/BUILDING.md#vehicle-climate-occupancy-isolation-protocol-186-unreleased).
...
against inert targets. See [validation and limits](../docs/BUILDING.md#observer-tyre-health-inputs-protocol-194-unreleased).
...
See [parked observer validation](../docs/BUILDING.md#parked-observer-tyre-health-protocol-195-unreleased).
...
See [validation and limits](../docs/BUILDING.md#native-wheel-pressure-application-protocol-196-unreleased).
...
See [validation and limits](../docs/BUILDING.md#observer-gearbox-condition-input-protocol-198-unreleased).
...
motion, replacement or teardown. See [claim validation and limits](../docs/BUILDING.md#guest-condition-claim-inputs-protocol-199-unreleased).
...
v202 adds no host wear consumer; the v203 consumer is described below. [Validation and limits](../docs/BUILDING.md#native-differential-speed-telemetry-protocol-202-unreleased).
...
See [native checks and remaining repair/wear work](../docs/BUILDING.md#wheel-rim-presentation-protocol-208-unreleased).
...
See [native checks and remaining work](../docs/BUILDING.md#host-wheel-health-inputs-protocol-209-unreleased).
...
[Local validation and limits](../docs/BUILDING.md#moose-meat-output-2026-09-13-unreleased-v224).
...
[BUILDING](../docs/BUILDING.md#shared-phone-bill-payments-2026-09-13-unreleased-v230).
...
[validation and limits](../docs/BUILDING.md#guest-home-stove-cooking-2026-09-13-unreleased-v233).
...
[SYNC-SCOPE-AUDIT.md](../docs/SYNC-SCOPE-AUDIT.md#taxi-native-lifecycle-audit-and-pickup-prerequisite-2026-09-14-still-v239).
